...
def deterministic_context(seed_str: str):
    ...
    if freeze_time:
        ...
        # Ignore urllib3 and requests to prevent SSL warnings when time jumps too far
        time_freezer = freeze_time(start_date, auto_tick_seconds=0.01, ignore=['urllib3', 'requests', 'httpx'])
        time_freezer.start()
